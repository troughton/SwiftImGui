...
typedef int ImIVec2 __attribute__((ext_vector_type(2)));
typedef int ImIVec3 __attribute__((ext_vector_type(3)));
...
typedef float ImVec2 __attribute__((ext_vector_type(2)));
typedef float ImVec4 __attribute__((ext_vector_type(4)));
