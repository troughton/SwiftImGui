...
typedef enum {
    ...
    ImGuiFocusedFlags_DockHierarchy = 1 << 3,
...
typedef enum {
    ...
    ImGuiHoveredFlags_DockHierarchy = 1 << 3,
    ImGuiHoveredFlags_AllowWhenBlockedByPopup = 1 << 4,
...
CIMGUI_API bool igIsWindowChildOf(ImGuiWindow* window,ImGuiWindow* potential_parent,bool dock_hierarchy);
